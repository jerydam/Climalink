...
export const CONTRACTS = {
  ...
  DAO: {
    address: "0x8FfFfFffFFfffFFfFFfFFFFFffFFFffffFfFFFfF",
    abi:[
	{
		"inputs": [
			{
  ...
  CLIMATE: {
	...
	{
		"inputs": [],
		"name": "joinAsReporterOrValidator",
		"outputs": [
			{
				"internalType": "enum ClimaLinkClimate.Role",
				"name": "",
