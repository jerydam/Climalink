          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <h1 className="text-2xl font-bold mb-4">
                Reporter Access Required
              </h1>
              <p className="text-muted-foreground mb-6">
                You need to be registered as a reporter to submit climate
                reports. Please join as a reporter or validator to continue.
              </p>
              ...
              <div className="grid gap-4">
                ...
                <Button onClick={joinAsValidator} variant="outline">
...
export default function SubmitReportPage() {
  ...
  const handleWeatherDataFetched = (fetchedWeather: WeatherData) => {
  ...
  const handleWeatherFetchError = (error: string | null) => {
    ...
    try {
      ...
      try {
        ...
        setWeatherFetchError(
          "Weather data not available, please enter manually"
        );
        ...
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Share weather data from your location and earn CLT rewards
              </p>
            </div>
          </div>
          ...
          {step === 1 && (
            <div className="space-y-6">
              <LocationInput
                ...
                onWeatherFetchError={handleWeatherFetchError}
              />
              ...
              <div className="">
                <Link href={"/predict"}>
                  <Button className="w-full bg-secondary hover:bg-secondary/80">Check Predicted Weather Forecast</Button>
                </Link>
              </div>
            </div>
          )}
