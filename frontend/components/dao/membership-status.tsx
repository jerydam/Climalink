...
import { Users, Coins, Vote, TrendingUp } from "lucide-react"
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-climate-green">Active</div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">2 passed, 1 active</p>
        </CardContent>
      </Card>
    </div>
  )
